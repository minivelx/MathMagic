...
public class Plantilla_Agilidad extends AppCompatActivity {

    TextView mTextField;
    CountDownTimer waitTimer;
    Button b1,b2,b3,b4;
    TextView problema, fraccion,denominador, signo, base,exp;
    ...
    long tiempoRestante = 15000;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_plantilla__agilidad);
    ...
    public void iniciar(){
        ...
        waitTimer = new CountDownTimer(tiempoRestante, 1000) {

            public void onTick(long millisUntilFinished) {
                mTextField.setText("Tiempo Restante: " + millisUntilFinished / 1000);
            ...
            public void onFinish() {
                ...
                //lanzamos el reporte
                Intent intent = new Intent(Plantilla_Agilidad.this,Resumen.class);
                intent.putExtra("Puntos",puntos);
                intent.putExtra("Agilidad",1);
                intent.putExtra("Contestados",contestados);
    ...
    public void btnPulsado(int ref_btn) {
        ...
        if (ref_btn == btn_correcto) {
            parar();
            tiempoRestante +=3000; //regalamos 3 seg de premio
            iniciar();
            puntos +=5;
        }else{
            tiempoRestante -=3000; //regalamos 3 seg de premio
